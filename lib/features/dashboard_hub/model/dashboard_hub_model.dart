...
class DashboardModuleItem {
  ...
  static List<DashboardModuleItem> items = [
    ...
    DashboardModuleItem(
      ...
      routeName: RouteNames.hospitalPerformance,
      colorTheme: 'green',
      onTap: () {},
    ),
    DashboardModuleItem(
      ...
      routeName: RouteNames.opdAnalytics,
      colorTheme: 'blue',
      onTap: () {},
    ),
    DashboardModuleItem(
    ...
    DashboardModuleItem(
      ...
      routeName: RouteNames.mchDashboard,
      colorTheme: 'pink',
      onTap: () {},
    ),
    DashboardModuleItem(
      ...
      routeName: RouteNames.radiologyImaging,
      colorTheme: 'cyan',
      onTap: () {},
    ),
    DashboardModuleItem(
