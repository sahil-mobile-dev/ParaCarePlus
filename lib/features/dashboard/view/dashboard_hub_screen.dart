              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Hero Banner with 6 key health counters
                    const EcosystemHero(),
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // 1. Active Outbreak Alerts Banner
                          _buildOutbreakAlertsBanner(context),
                          const SizedBox(height: AppSpacing.lg),

                          // 2. 8 Quick Stats strip
                          const QuickStatsStrip(),
                          const SizedBox(height: AppSpacing.xl),

                          // 3. View As: Role Bar Selector
                          _buildRoleSelectorBar(),
                          const SizedBox(height: AppSpacing.lg),

                          // 4. Category chips and Search field
                          _buildSearchAndFiltersRow(context),
                          const SizedBox(height: AppSpacing.xl),

                          // 5. Dynamic grid of 25+ administrative modules
                          _buildModulesSection(filteredModules),
                          const SizedBox(height: AppSpacing.xl),

                          // 6. Role-Based Access guide
                          _buildAccessGuideSection(),
                          const SizedBox(height: AppSpacing.xl),

                          // 7. Phase C Patient Portal Block
