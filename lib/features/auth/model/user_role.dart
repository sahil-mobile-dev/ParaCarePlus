...
enum UserRole {
  masterAdmin('Master Admin', 'Master Admin Access', Icons.admin_panel_settings_rounded),
  stateSuperAdmin('State Super Admin', 'State Super Admin Access', Icons.account_balance_rounded),
  administrator('Administrator', 'Administrator Access', Icons.manage_accounts_rounded),
  ...
  labTechnician('Lab Technician', 'Lab Technician Access', Icons.science_rounded),
  ...
  ambulanceDriver('Ambulance Driver', 'Ambulance Driver Access', Icons.airport_shuttle_rounded);
