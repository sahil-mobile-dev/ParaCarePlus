...
class OpdTokenViewModel extends _$OpdTokenViewModel {
  ...
  Future<void> _searchPatients(String query) async {
    ...
    final allMockPatients = [
      ...
      const PatientSummary(mrn: 'MRN004', name: 'Anjali Gupta', age: '28', sex: 'Female', phone: '9988776655'),
      const PatientSummary(mrn: 'MRN005', name: 'Vikram Singh', age: '40', sex: 'Male', phone: '8877665544'),
    ];
